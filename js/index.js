window.addEventListener('load', () => {
    ...
    function tilesBlink() {
        ...
        Array.prototype.forEach.call(tiles, function (tiles) {
            tiles.animate([{ opacity: 0 }, { opacity: 1 }, { opacity: 0 }], {
    ...
    gnb_icon.addEventListener('click', () => {
        if (!gnb_nyan.classList.contains('gnb_on')) {
            ...
            gnb_nyan.animate({ right: 0 }, { duration: 500, fill: 'forwards' });

            gnb_nyan.classList.add('gnb_on');
            gnb_icon.src = './img/header/jelly_back_short.png';
        } else {
            gnb_nyan.animate({ right: `-${gnb_width}px` }, { duration: 500, fill: 'forwards' });
    ...
    gnb_icon.addEventListener('click', () => {
        for (let j = 0; j < gnb_mobiles.length; j++) {
            ...
            setTimeout(() => {
                gnb_mobiles[j].animate([{ opacity: '1' }], {
                    duration: 500,
                    easing: 'ease-in',
                    fill: 'forwards',
                });
        ...
        setTimeout(() => {
            gnb_bead.animate([{ transform: 'rotateZ(720deg)', right: '200px' }], {
                duration: 1000,
                delay: 0,
                fill: 'forwards',
            });
    ...
    Array.prototype.forEach.call(gnb_mobile, function (gnb_mobile) {
    ...
    let gnb_crayon_ani = [
        ...
        { transform: 'RotateZ(0)', offset: 0.5 },
    ...
    function gnb_cat_push(kitty) {
        Array.prototype.forEach.call(li_img, (cat, idx) => {
            cat.innerHTML = '';
        ...
        Array.prototype.forEach.call(li_txt, (cat, idx) => {
    ...
    Array.prototype.forEach.call(gnb_list_li, (gnb_list_li, idx) => {
    ...
    Array.prototype.forEach.call(gnb_main_li, (gnb_main_li, idx) => {
    ...
    intro_images.animate(
        { transform: 'rotateZ(720deg)', left: `${intro_kitty_axis}px` },
        {
            duration: 3000,
            delay: 0,
            fill: 'forwards',
    ...
    setTimeout(() => {
        intro_images.animate(
            { transform: 'rotateZ(360deg)', left: `0px` },
            {
                duration: 2000,
                delay: 0,
                fill: 'forwards',
    ...
    Array.prototype.forEach.call(intro_lines_img, (intro_lines_img, idx) => {
    ...
    setTimeout(() => {
        intro_click_hi.animate(intro_scale_ani, {
            duration: 1000,
            fill: 'forwards',
        });
    }, 5600);
    ...
    intro_images.addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            intro_wave.animate([{ opacity: 0.5 }, { opacity: 0.2, offset: 0.5 }, { opacity: 0.0, offset: 0.75 }], {
                duration: 1000,
                easing: 'linear',
            });

            Array.prototype.forEach.call(intro_waves, (intro_waves, idx) => {
                intro_waves.animate([{ scale: 0 }, { scale: 2 }], {
                    duration: 1000,
                    delay: idx * 2000,
                });
            });
    ...
    Array.prototype.forEach.call(intro_title_letter, (intro_title_letter) => {
    ...
    for (let m = 0; m < intro_title_letter.length; m++) {
        setTimeout(() => {
            intro_title_letter[m].animate([{ color: identity$ }], {
                duration: 600,
            });
        }, m * 50);
    ...
    setTimeout(() => {
        intro_kitty_stroke.animate([{ opacity: 1 }, { opacity: 0 }], {
            duration: 300,
            fill: 'forwards',
        });
        ...
        setTimeout(() => {
            ...
            intro_kitty_stroke.animate([{ opacity: 0 }, { opacity: 1 }], {
                duration: 300,
                fill: 'forwards',
            });
        }, 300);
        ...
        setTimeout(() => {
            intro_kitty_stroke.animate(stroke_kitty_frame, {
                duration: 1000,
                fill: 'forwards',
            });
        }, 300);
    ...
    Array.prototype.forEach.call(trace_en, (trace_en, idx) => {
        trace_en.classList.add(`m${idx}_trace_en`);
    });

    let main_h2 = document.querySelectorAll('.title_text_area h2');
    Array.prototype.forEach.call(main_h2, (main_h2, idx) => {
    ...
    function h2_ani() {
        setInterval(() => {
            if (w_width < tablet_cat) {
                Array.prototype.forEach.call(trace_en, (trace_en) => {
                    trace_en.animate(
                ...
                Array.prototype.forEach.call(trace_en, (trace_en, idx) => {
                    ...
                    Array.prototype.forEach.call(semi_trace, (semi_trace, idx) => {
                        semi_trace.animate(
                            [
                                { opacity: 1, offset: 0 },
            ...
            setTimeout(() => {
                Array.prototype.forEach.call(main_h2, (data, idx) => {
                    let main_h2_letter = document.querySelectorAll(`.m${idx}_h2_letter`);
                    Array.prototype.forEach.call(main_h2_letter, (main_h2_letter, idx) => {
    ...
    Array.prototype.forEach.call(about_me_base, (cat) => {
        cat.style.opacity = 0;
        cat.style.scale = 0;
    });
    ...
    Array.prototype.forEach.call(about_me_lines, (cat) => {
        cat.style.opacity = 0;
        cat.style.scale = 0;
    });
    ...
    const about_me_back_fadein = () => {
        Array.prototype.forEach.call(about_me_base, (cat, idx) => {
            cat.animate([{ opacity: 1, scale: 1.0 }], {
                duration: 500,
                delay: idx * 500,
                fill: 'forwards',
                easing: 'ease-in',
    ...
    let about_me_kitty_move = () => {
        ...
        setTimeout(() => {
            ...
            about_me_kitty.animate(
                [{ transform: 'rotateZ(0deg)' }, { transform: 'rotateZ(-5deg)' }, { transform: 'rotateZ(0deg)' }],
                {
                    duration: 2000,
                    iterations: 'Infinity',
                }
    ...
    axios
        ...
        .then((res) => {
            ...
            function h3Ani() {
                ...
                Array.prototype.forEach.call(idc_span, (cat, idx) => {
            ...
            function cmtAni() {
                ...
                Array.prototype.forEach.call(cmt_span, (cat, idx) => {
                    cat.style.opacity = 0;
                    cat.style.display = 'inline-block';
            ...
            function expAni(kitty) {
                // kitty: normal 혹은 reverse
                Array.prototype.forEach.call(descri_explain_div, (cat, idx) => {
            ...
            function am_changer(cat) {
                ...
                Array.prototype.forEach.call(descri_explain_div, (cat2, idx) => {
            ...
            function am_gauge_ani() {
                am_gauge_crt.animate([{ width: '0%' }, { width: '100%' }], {
            ...
            function amSpot(kitty) {
                Array.prototype.forEach.call(rest_list, (cat, idx) => {
            ...
            Array.prototype.forEach.call(rest_list, (cat, newidx) => {
    ...
    function about_me_descri_set() {
        ...
        Array.prototype.forEach.call(about_me_descri_div, (cat) => {
    ...
    function about_me_descri_move() {
        Array.prototype.forEach.call(about_me_descri_div, (cat, idx) => {
            cat.animate(
                {
                    right: 0,
                    opacity: 1,
    ...
    function fw_swing() {
        Array.prototype.forEach.call(ms_contents_grp, (cat, idx) => {
    ...
    window.addEventListener('scroll', () => {
        if (ms_scroll) {
            if (window.scrollY + w_height > main_myspecs$.offsetTop + main_myspecs$.offsetHeight / 2) {
                Array.prototype.forEach.call(ms_kitty_img, (cat, idx) => {
                    setTimeout(() => {
                        spec_fireworks(idx);
                    }, idx * 500);
    ...
    function mkClick() {
        setInterval(() => {
            Array.prototype.forEach.call(mk_p_letter, (cat, idx) => {
    ...
    axios
        ...
        .then((res) => {
            ...
            Array.prototype.forEach.call(mk_skill_zone, (cat) => {
            ...
            Array.prototype.forEach.call(mk_skill_cod, (cat, idx) => {
                cat.querySelector('circle').style.stroke = `${mcl$[idx].tone}`;
                cat.style.scale = 0;
                cat.style.opacity = 0;
            });

            Array.prototype.forEach.call(mk_skill_gph, (cat, idx) => {
            ...
            document.addEventListener('scroll', () => {
                if (mk_scroll) {
                    if (w_width < semi_cat) {
                        if (
                            window.scrollY + w_height >
                            main_myskills$.offsetTop + main_myskills$.offsetHeight / 2 + mk_skills_kitty.offsetHeight
                        ) {
            ...
            function mk_kitty_drop() {
                ...
                setTimeout(() => {
                    ...
                    setInterval(() => {
                        Array.prototype.forEach.call(mk_kitty_zzz, (cat, idx) => {
                            cat.animate([{ opacity: 1 }, { opacity: 1, offset: 0.99 }, { opacity: 0 }], {
            ...
            function mk_icons_ani(kitty) {
                Array.prototype.forEach.call(kitty, (cat, idx) => {
                    cat.animate(
                        [
                            { scale: 0, opacity: 0 },
                            { scale: 1, opacity: 1 },
            ...
            function mkk_gauge_ani(kitty, prof, freq) {
                ...
                kitty[1].animate([{ width: `0` }, { width: `${freq}%` }], {
                    duration: 1000,
                    fill: 'forwards',
                });
            }
            ...
            function mkk_changer(cat1, cat2) {
                Array.prototype.forEach.call(cat1, (cat, idx) => {
                    cat.addEventListener('click', () => {
                        ...
                        Array.prototype.forEach.call(mkd_bcolor, (cat, kitty) => {
            ...
            Array.prototype.forEach.call(mk_gnb_all, (cat, idx) => {
                cat.addEventListener('click', () => {
                    mk_gauge_ani_entire();
                    if (w_width < semi_cat)
                        window.scrollTo({
                            top: main_myskills$.offsetTop + main_myskills$.offsetHeight / 2,
                            behavior: 'smooth',
                        });
                    ...
                    if (idx) {
                        ...
                        Array.prototype.forEach.call(mk_graphic.children, (cat) => {
                            cat.animate(
                                { opacity: 0, scale: 0 },
                                {
                                    fill: 'forwards',
                        ...
                        Array.prototype.forEach.call(mk_coding.children, (cat) => {
                            cat.animate(
                                { opacity: 0, scale: 0 },
                                {
                                    fill: 'forwards',
    ...
    axios
        ...
        .then((res) => {
            ...
            function proj_generator(cat, kitty) {
                Array.prototype.forEach.call(cat, (neko, idx) => {
                    kitty += `
                    <div class="proj_${neko.tag}">
                        <div class="proj_flex">
                            <div class="proj_photo">
                                ...
                                <img class="proj_back" src="./img/main/pj_${
                                    neko.tag
                                }_line.png" alt="프로젝트 배경 라인">
                            </div>
                            ...
                            <div class="proj_contents">
                                ...
                                <div class="proj_info">
                                    <div class="proj_detail">
                                        ...
                                        <div class="info_date">
                                            <h5>작업 기간</h5>
                                            <p class="p_date"><span style="color:${
                                                neko.main_tone
                                            }" class="info_highlight">${neko.peri}</span>일</p>
                                        </div>
    
                                        <div class="info_per">
                                            <h5>작업 인원</h5>
                                            <p class="p_per"><span style="color:${
                                                neko.main_tone
                                            }" class="info_highlight">${neko.con}</span>명</p>
                                        </div>
                                    </div>
                ...
                if (cat.tone_count) {
                    for (let pjt = 0; pjt < cat.tone_count; pjt++) {
                        ...
                        <div class="tone_cat tone_${cat.tag}" style="width:${100 / cat.tone_count}%">
                            <svg id="tone_cat_${
                                cat.tag
                            }_${pjt}" data-name="레이어 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 47.59">
                                <path style="fill: ${cat.tone[pjt]}; stroke: ${
                            cat.stroke[pjt]
            ...
            Array.prototype.forEach.call(pj_gnb_li, (cat2, idx2) => {
                ...
                cat2.addEventListener('click', () => {
                    ...
                    Array.prototype.forEach.call(pj_kitty, (cat2) => {
                        cat2.innerHTML = '';
                    });
                    Array.prototype.forEach.call(pj_gnb_li, (cat2) => {
                        cat2.classList.remove('common_under');
                    });
                    cat2.classList.add('common_under');
                    pj_gnb_kitty.innerHTML = '<img src="./img/main/my_skills_gnb_cat.png" alt="gnb_kitty">';
                    if (idx2 == 0) {
            ...
            function pj_ani_entire(pj_neko) {
                Array.prototype.forEach.call(proj, (cat, idx) => {
                    ...
                    window.addEventListener('scroll', () => {
                        if (pj_neko[idx]) {
                            if (
                                window.scrollY + w_height >
                                pj_big_nyan.offsetTop + cat.offsetTop + cat.offsetHeight / 2
                            ) {
                                pj_kitty_ani(idx);
                                pj_neko[idx] = false;
                            }
                    ...
                    function pj_opacity() {
                        ...
                        Array.prototype.forEach.call(pj_infos, (cat) => {
                            cat.style.opacity = 0;
                        });
                    }
                    ...
                    function pj_kitty_ani(neko) {
                        ...
                        proj_photo.animate(
                            [
                                {
                                    transform: `translateX(${pj_idx_x(neko)}px) translateY(${pj_idx_y(
                                        neko
                                    )}px) rotate(${pj_idx_deg(neko, 15)})`,
                                    opacity: 1,
                                },
                        ...
                        Array.prototype.forEach.call(pj_infos, (cat, idx) => {
                            cat.animate(
                                [
                                    { transform: `translateX(${-pj_idx_x(neko)}px)`, opacity: 1 },
                                    { transform: 'translateX(0)', opacity: 1 },
                        ...
                        Array.prototype.forEach.call(proj_back, (cat, idx) => {
                            cat.style.scale = 0;
                            cat.animate([{ scale: 0 }, { scale: 1 }], {
                                duration: 500,
                                delay: 1000 + 200 * idx,
                                fill: 'forwards',
                            });
                                    ...
                                    <div class="semi_nyan_zone">
                                        <div class="ov_flex">
                                            ...
                                            <div class="ov_cts_area">
                                                ...
                                                <p class="ov_period">${cat.ov.period[0]} ~ ${cat.ov.period[1]}(${
                    cat.ov.date
                }일)</p>
            ...
            function put_dtnm(meow, felis) {
                // meow: 루프 횟수, cat: 데이터 push 위치, felis: 데이터 이름
                let kitty = '';
            ...
            function webSetter(kitty) {
                ...
                Array.prototype.forEach.call(link_btns, (cat, idx) => {
                    cat.addEventListener('click', () => {
            ...
            function dn_modal(kitty, meow) {
                Array.prototype.forEach.call(kitty, (cat, idx) => {
                    cat.addEventListener('click', function () {
                        ...
                        Array.prototype.forEach.call(design_bigheads, (cat) => {
                            cat.style.opacity = 0;
                        });

                        design_note_in.animate(
                            { scale: 1 },
                            {
                                duration: 500,
                                fill: 'forwards',
                        ...
                        setTimeout(() => {
                            Array.prototype.forEach.call(design_bigheads, (cat, idx) => {
                                cat.animate(
                                    { opacity: 1 },
                                    {
                                        duration: 500,
                        ...
                        Array.prototype.forEach.call(dn_close_btns, (cat) => {
                            cat.addEventListener('click', function () {
                        ...
                        dn_git_web.addEventListener('click', () => {
                            dnote.header.web_link
                                ? window.open(dnote.header.web_link)
                                : alert('미완성된 사이트입니다.');
                        });
                    });
                });
    ...
    function cm_contents_set() {
        ...
        Array.prototype.forEach.call(cm_main_div, (cat) => {
            cat.style.opacity = 0;
            cat.style.transform = `translate(${cm_contents_area_w}px, ${nyan_cat()}px)`;
        });

        Array.prototype.forEach.call(cm_sub_div, (cat) => {
            cat.style.opacity = 0;
    ...
    window.addEventListener('scroll', () => {
        if (cm_scroll) {
            if (window.scrollY + w_height > main_contactme$.offsetTop + main_contactme$.offsetHeight / 2) {
                ...
                Array.prototype.forEach.call(cm_main_div, (cat, idx) => {
                    cat.animate(
                        { transform: 'translate(0, 0)', opacity: 1 },
                        {
                            duration: 1000,
                ...
                setTimeout(() => {
                    setInterval(() => {
                        cm_kitty_icon.animate(stroke_kitty_frame, {
                            duration: 1000,
                            fill: 'forwards',
                        });
                    }, 3000);
    ...
    function cm_contents_toggle(kitty1, kitty2) {
        ...
        Array.prototype.forEach.call(kitty1, (cat, idx) => {
            cat.animate(
                {
                    transform: `translate(${cm_contents_area_w}px, ${nyan_cat()}px)`,
                    opacity: 0,
                },
                {
                    duration: 1000,
        ...
        setTimeout(() => {
            Array.prototype.forEach.call(kitty2, (cat, idx) => {
                if (idx == 2) {
                    cat.style.display = 'flex';
                } else cat.style.display = 'block';
                cat.animate(
    ...
    document.addEventListener('scroll', () => {
        if (traces_scroll) {
            if (window.scrollY + w_height > footer_trace.offsetTop) {
                Array.prototype.forEach.call(traces_g, (cat, idx) => {
                    cat.style.opacity = 0;
    ...
    window.addEventListener('scroll', () => {
        if (ft_scroll) {
            if (window.scrollY + w_height > footer_important.offsetTop + footer_important.offsetHeight / 2) {
                ...
                Array.prototype.forEach.call(footer_icons, (cat, idx) => {
                    ...
                    cat.addEventListener('click', () => {
                        switch (idx) {
                            case 0:
                                ...
                                break;
                            case 1:
                                window.open('https://open.kakao.com/o/sN6NzS0e');
                                break;
                            case 2:
                                document.location.href = 'tel:010-9084-9222';
                                break;
                            case 3:
                                window.scrollTo({ top: 0, behavior: 'smooth' });
                                break;
                            case 4:
                                window.open('https://kidcatnyantopia.tistory.com/');
                                break;
                        }
                    });
                });
